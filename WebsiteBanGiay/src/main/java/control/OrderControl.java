		...
		try {
			...
			String deliveryAddress = request.getParameter("deliveryAddress");
			 ...
			 HttpSession session = request.getSession();
				...
				email.setFrom("phungvantiendat@gmail.com"); //chinh lai email quan tri tai day [chu y dung email con hoat dong]
				email.setFromPassword("rhwaettvbasrfixn"); //mat khau email tren
				email.setTo(emailAddress);
				email.setSubject("Dat hang thanh cong tu VaultVietNam");
				StringBuilder sb = new StringBuilder();
				sb.append("Dear ").append(name).append("<br>");
				sb.append("Ban vua dat dang tu Vault VietNam. <br> ");
				...
				sb.append("Tong Tien: ").append(String.format("%.03f",totalMoneyVAT)).append("$").append("<br>");
				sb.append("Cam on ban da dat hang tai Vault VietNam ♥<br>");
