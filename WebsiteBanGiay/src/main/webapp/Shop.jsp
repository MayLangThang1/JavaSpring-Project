            ...
            <section>
              ...
              <section class="mb-4">
                ...
                <div class="form-check pl-0 mb-3">
                  ...
                  <label class="form-check-label small text-uppercase card-link-secondary" for="100200">1.000.000 VND to
                    2.000.000 VND</label>
                </div>
                <div class="form-check pl-0 mb-3">
                  <input onchange="searchByPriceAbove200()" type="radio" class="form-check-input" id="200above" name="materialExampleRadios">
                  <label class="form-check-label small text-uppercase card-link-secondary" for="200above">2.000.000 VND &
                    Above</label>
                </div>
                <form>
              ...
              <div class="col-md-4 mb-5">
                ...
                <div class="">
                  ...
                  <div class="text-center pt-4">
                    ...
                    <h5>${o.name }</h5>
                    <p><span class="mr-1"><strong>${o.price }00₫</strong></span></p>
